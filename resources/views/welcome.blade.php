                ...
                <div class="card-body">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg right">
                      ...
                      <!-- /.direct-chat-infos -->
                      <img class="direct-chat-img" src="{{ asset('template/user3-128x1dist/img28.jpg') }}" alt="message user image">
                      <!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <!-- /.direct-chat-infos -->
                      <img class="direct-chat-img" src="{{ asset('template/dist/img/user1-128x128.jp') }}g" alt="message user image">
                      <!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
